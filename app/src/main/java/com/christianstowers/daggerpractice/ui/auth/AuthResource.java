...
// basically a wrapper class, wraps around some type of T (in this case the User object),
// giving access to other states and objects that are helpful as Retrofit query requests are made.
